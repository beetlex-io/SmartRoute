...
namespace SmartRoute
{
	static class ObjectSerializeExpand
	{
		...
		//private static Hyperion.Serializer mSerializer = null;
		//public static Hyperion.Serializer Serializer
		//{
		//	get
		//	{
		//		if (mSerializer == null)
		//			mSerializer = new Hyperion.Serializer();
		//		return mSerializer;
		//	}
		//}
		...
		public static void Serialize(this object data, System.IO.Stream stream)
		{
			...
			//ValueSerializer ser = Serializer.GetSerializerByType(data.GetType());
			//ser.WriteValue(stream, data, Serializer.GetSerializerSession());


		}
		public static object Deserialize(this System.IO.Stream stream, int length, Type type)
		{
			//ValueSerializer ser = Serializer.GetSerializerByType(type);
			//return ser.ReadValue(stream, Serializer.GetDeserializerSession());
